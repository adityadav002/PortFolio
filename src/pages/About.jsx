  ...
  return (
    <>
        ...
        <div className="introduction">
          <h3>About Me</h3>
          <h1>I'm <span>ADITYA YADAV</span></h1>
          <br />
          <hr />
          <br />  
          <p>
            I'm a passionate and detail-oriented Software Engineer specializing
            in the MERN stack (MongoDB, Express, React, Node.js) and Python,
            with a focus on advanced technologies like OpenCV for computer
            vision applications.Whether you're looking to build a full-stack web
